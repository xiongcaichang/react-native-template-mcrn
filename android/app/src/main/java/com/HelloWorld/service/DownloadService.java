...
import static com.HelloWorld.base.Constants.JS_BUNDLE_FILE_NAME;
...
public class DownloadService extends IntentService {
    ...
    public final static String NOTIFI_TITLE = "HelloWorld";
    public final static String NOTIFI_DESC = "HelloWorld";
...
//      安装完成后，启动app（源码中少了这句话）
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            uri = FileProvider.getUriForFile(this, "com.HelloWorld.fileProvider", apkFile);
